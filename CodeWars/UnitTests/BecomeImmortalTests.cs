...
namespace UnitTests
{
	...
	class BecomeImmortalTests
    {
		...
		public void Example()
		{
            ...
            //Assert.AreEqual((long)11925, BecomeImmortalKata.ElderAge(31, 25, 0, 100007));
            //Assert.AreEqual((long)4323, BecomeImmortalKata.ElderAge(45, 5, 3, 1000007));
            //Assert.AreEqual((long)1586, BecomeImmortalKata.ElderAge(39, 31, 7, 2345));
